...
/**
 * Servlet implementation class FetchTheAssigneeToMeTodo
 */
//@WebServlet("/FetchTheAssigneeToMeTodo")
public class FetchTheAssigneeToMeTodo extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FetchTheAssigneeToMeTodo() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		 String Id = request.getParameter("Id"); 
			...
			String userId="";
		     ...
		     List<TodoDetailsClass> list = FetchDataClass.getInstance().getAssigneeToMeRecords(Id,userId);
	    ...
	    //ystem.out.println("\n--------------------------------------i==u=94="+i);
		    	 System.out.println("enter---------------");
			    		...
			    		responseObject1.put("Assignedby", list.get(i).getAssinedBy());
